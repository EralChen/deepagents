...
## [0.1.42](https://github.com/EralChen/deepagents/compare/deepagents-code==0.1.41...deepagents-code==0.1.42) (2026-07-17)


### Features

* **code,quickjs:** dynamic subagents UI ([#4221](https://github.com/EralChen/deepagents/issues/4221)) ([10bcba2](https://github.com/EralChen/deepagents/commit/10bcba25600e51aba135f170b34aa6315c0f53d6))
* **code,sdk:** add rubric iteration controls ([#4405](https://github.com/EralChen/deepagents/issues/4405)) ([d6692a7](https://github.com/EralChen/deepagents/commit/d6692a7c713490f170b17510d613e02ee37574ab))
* **code:** `/model` Ctrl+N toggle for names vs raw specs ([#4592](https://github.com/EralChen/deepagents/issues/4592)) ([518c322](https://github.com/EralChen/deepagents/commit/518c322e7dda840b5a740541afc895516a74925f))
* **code:** `/tools` slash command ([#4649](https://github.com/EralChen/deepagents/issues/4649)) ([b1600a8](https://github.com/EralChen/deepagents/commit/b1600a8da784899d9db5bdf93be07b4c7f53a46c))
* **code:** `dcode doctor` diagnostics command ([#4148](https://github.com/EralChen/deepagents/issues/4148)) ([8179731](https://github.com/EralChen/deepagents/commit/81797312c7d857e7d94d03c9c695cd3c8d88799a))
* **code:** `tool.use` and `tool.result` hook events ([#3954](https://github.com/EralChen/deepagents/issues/3954)) ([ba1979d](https://github.com/EralChen/deepagents/commit/ba1979d64c3ed5e96ebc896197bc8f97f6f84bac))
* **code:** add "always allow" to project MCP approval prompt ([#4562](https://github.com/EralChen/deepagents/issues/4562)) ([ffab82a](https://github.com/EralChen/deepagents/commit/ffab82a9458d2a03b95cbc515f883212090a6992))
* **code:** add `-s` alias for `--skill` ([#4620](https://github.com/EralChen/deepagents/issues/4620)) ([c9b7ac2](https://github.com/EralChen/deepagents/commit/c9b7ac20752e4270d286b4af3fcf710e7e5bee87))
* **code:** add `[startup].mode` default approval mode ([#4573](https://github.com/EralChen/deepagents/issues/4573)) ([7c5bf54](https://github.com/EralChen/deepagents/commit/7c5bf542c2f58fa46ecd708c66cd1817a0ebdc41))
* **code:** add `Ctrl+X` to goal review editing ([#4780](https://github.com/EralChen/deepagents/issues/4780)) ([641b906](https://github.com/EralChen/deepagents/commit/641b906157db2c6ae476805f0714ae8f51040492))
* **code:** add `dcode tools list` command ([#4461](https://github.com/EralChen/deepagents/issues/4461)) ([1402d0e](https://github.com/EralChen/deepagents/commit/1402d0e735a1580503f240457c77db76fcd779d7))
* **code:** add `GPT-5.6` model family ([#4600](https://github.com/EralChen/deepagents/issues/4600)) ([4a806bc](https://github.com/EralChen/deepagents/commit/4a806bc703b69334cccd05bcd27d411602e82318))
* **code:** add `memory.auto_save` config flag ([#4700](https://github.com/EralChen/deepagents/issues/4700)) ([55b60ca](https://github.com/EralChen/deepagents/commit/55b60ca08da4eef294ac3c162610b2a151584ea5))
* **code:** add `reconnect`/`connect` hidden keywords for `/restart` ([#4807](https://github.com/EralChen/deepagents/issues/4807)) ([99250ee](https://github.com/EralChen/deepagents/commit/99250ee1749c977e95389baafde3d358c953ea0f))
* **code:** add Claude Sonnet 5 to model picker ([#4386](https://github.com/EralChen/deepagents/issues/4386)) ([64758dd](https://github.com/EralChen/deepagents/commit/64758dddf8b46c5b68c345fb1eac1fb7bcbf7f7e))
* **code:** add configurable chat cursor style ([#4687](https://github.com/EralChen/deepagents/issues/4687)) ([a22484b](https://github.com/EralChen/deepagents/commit/a22484ba2e001fd62fbff0fe916f1b3b93889fc3))
* **code:** add Fireworks session settings ([#4360](https://github.com/EralChen/deepagents/issues/4360)) ([90ebb1d](https://github.com/EralChen/deepagents/commit/90ebb1d68cb5942f07847f6dce48c14c7caef992))
* **code:** add Grok 4.5 model ([#4596](https://github.com/EralChen/deepagents/issues/4596)) ([b0a209d](https://github.com/EralChen/deepagents/commit/b0a209da3a8c9f80e2e3d5e199340736c854c567))
* **code:** add interactive goal management ([#4693](https://github.com/EralChen/deepagents/issues/4693)) ([64205e2](https://github.com/EralChen/deepagents/commit/64205e238c280ae05b2bf9253ac40c6f85ffb49c))
* **code:** add Kimi K3 to model selector under OpenRouter ([#4803](https://github.com/EralChen/deepagents/issues/4803)) ([fc94bb7](https://github.com/EralChen/deepagents/commit/fc94bb7da9e66218de063aa4415dcf9717f15fce))
* **code:** add LangSmith base URL to `/auth` ([#4228](https://github.com/EralChen/deepagents/issues/4228)) ([88d167f](https://github.com/EralChen/deepagents/commit/88d167f9ceec1cfadd7c3feac6f63c0da7c893f1))
* **code:** add LangSmith tracing config to `/auth` ([#4193](https://github.com/EralChen/deepagents/issues/4193)) ([8e62957](https://github.com/EralChen/deepagents/commit/8e6295791093c2ddfec7e6ac57f0df7f12048447))
* **code:** add Meta model provider ([#4650](https://github.com/EralChen/deepagents/issues/4650)) ([70829c5](https://github.com/EralChen/deepagents/commit/70829c5846b6bdde1cee51f0f4929e819ba1026b))
* **code:** add Opus 4.8 to recommended models ([#4204](https://github.com/EralChen/deepagents/issues/4204)) ([8faf2b0](https://github.com/EralChen/deepagents/commit/8faf2b025f8429481a41a3e65544d26614e53589))
* **code:** add plugin list search ([#4765](https://github.com/EralChen/deepagents/issues/4765)) ([a6c20b1](https://github.com/EralChen/deepagents/commit/a6c20b1a4d2a8b8a03690460a30c501ab7fbb6cb))
* **code:** add plugin marketplace support ([#4554](https://github.com/EralChen/deepagents/issues/4554)) ([0187d14](https://github.com/EralChen/deepagents/commit/0187d14b83301c116a2f177e6e04ae7a8cc99ca7))
* **code:** add reasoning effort selector ([#4403](https://github.com/EralChen/deepagents/issues/4403)) ([6ee0ac4](https://github.com/EralChen/deepagents/commit/6ee0ac4cca998f84e157187d565084e2a1912626))
* **code:** add rubric-backed goal workflow ([#4365](https://github.com/EralChen/deepagents/issues/4365)) ([8fca61d](https://github.com/EralChen/deepagents/commit/8fca61dc036888a4414ff5a4536b957c63dab4a5))
* **code:** add structured TUI display for `js_eval` ([#4151](https://github.com/EralChen/deepagents/issues/4151)) ([91c0dae](https://github.com/EralChen/deepagents/commit/91c0dae3fe0253f02a5926fcd3c6f796cd8d11fe))
* **code:** adopt coding-agent-v1 trace metadata ([#4367](https://github.com/EralChen/deepagents/issues/4367)) ([cb39747](https://github.com/EralChen/deepagents/commit/cb3974748024fcec2e2ee0ccc0a9b23c880733a2))
* **code:** allow dependency updates without requiring release ([#4157](https://github.com/EralChen/deepagents/issues/4157)) ([7beb97a](https://github.com/EralChen/deepagents/commit/7beb97a2b02e2fd238baf3b6f05d43a4accf3f42))
* **code:** auto-accept `/goal` criteria in YOLO mode ([#4784](https://github.com/EralChen/deepagents/issues/4784)) ([cc662f2](https://github.com/EralChen/deepagents/commit/cc662f236dbf72303be5cbf2c4cfd00710a2d32c))
* **code:** auto-detect MCP OAuth from 401 challenge ([#4364](https://github.com/EralChen/deepagents/issues/4364)) ([9763ffc](https://github.com/EralChen/deepagents/commit/9763ffceab8800526ae9fe10decdb2f32d8e4707))
* **code:** auto-retry credentials-blocked startup after `/auth` ([#4176](https://github.com/EralChen/deepagents/issues/4176)) ([d10ba3d](https://github.com/EralChen/deepagents/commit/d10ba3dc162e47cc71df56b8e3d0000b6e0ed847))
* **code:** clear chat input via `esc+esc`, add `[ X ]/[ COPY ]` buttons ([#4000](https://github.com/EralChen/deepagents/issues/4000)) ([c20546f](https://github.com/EralChen/deepagents/commit/c20546feac7876786e6816776d1ccfa5fcd4b2c8))
* **code:** collapse completed tool calls into group summaries ([#4373](https://github.com/EralChen/deepagents/issues/4373)) ([3735829](https://github.com/EralChen/deepagents/commit/3735829a0c14fb1537daf930140c66b647c8222c))
* **code:** collapse large pastes into compact placeholders ([#4447](https://github.com/EralChen/deepagents/issues/4447)) ([9ae927d](https://github.com/EralChen/deepagents/commit/9ae927d73ebf30ba50bbb7ec0c1076a0937e5cb7))
* **code:** collect Tavily key during onboarding ([#4233](https://github.com/EralChen/deepagents/issues/4233)) ([e321cba](https://github.com/EralChen/deepagents/commit/e321cba5701313e974f979069186680f1a39587c))
* **code:** confirm "Launched" after auto-update restart ([#4098](https://github.com/EralChen/deepagents/issues/4098)) ([df8db8a](https://github.com/EralChen/deepagents/commit/df8db8af6a7cbfc2ab535020b951d73759da73dd))
* **code:** Debug Console thread ID click-to-copy with LangSmith link ([#4760](https://github.com/EralChen/deepagents/issues/4760)) ([2d35507](https://github.com/EralChen/deepagents/commit/2d35507b5c7ff7f504f3d294ac499140752c4f59))
* **code:** drop `TodoListMiddleware` ([#4685](https://github.com/EralChen/deepagents/issues/4685)) ([d3a3077](https://github.com/EralChen/deepagents/commit/d3a3077e8536696dcf4a9dcd8555e9c871562e74))
* **code:** enable `js_eval` by default ([#4245](https://github.com/EralChen/deepagents/issues/4245)) ([2e04ff3](https://github.com/EralChen/deepagents/commit/2e04ff397e60389c9a19c4a9b528e15602ad8338))
* **code:** expand environment variables in MCP config ([#4681](https://github.com/EralChen/deepagents/issues/4681)) ([4f5d7be](https://github.com/EralChen/deepagents/commit/4f5d7be1b4073dee346e5a974841721646fa4860))
* **code:** fall back to folder name for subagents ([#4504](https://github.com/EralChen/deepagents/issues/4504)) ([9db3db5](https://github.com/EralChen/deepagents/commit/9db3db5f31a93fb8598a5dc5bedf4fe61fe92c94))
* **code:** gate onboarding integrations modal behind opt-in flag ([#4227](https://github.com/EralChen/deepagents/issues/4227)) ([6c930c5](https://github.com/EralChen/deepagents/commit/6c930c5e4502f572be554acc896c5fb6d061e0e5))
* **code:** gate paste auto-collapse behind `display.collapse_pastes` ([#4473](https://github.com/EralChen/deepagents/issues/4473)) ([ff5dd56](https://github.com/EralChen/deepagents/commit/ff5dd564a3a590e7d2d521b20df495b5e1512e12))
* **code:** hide diff widget for credential files ([#4593](https://github.com/EralChen/deepagents/issues/4593)) ([4c49a24](https://github.com/EralChen/deepagents/commit/4c49a24c4c488f45859b45628cfa57719e52f596))
* **code:** improve `/goal` criteria UX ([#4694](https://github.com/EralChen/deepagents/issues/4694)) ([06f46ff](https://github.com/EralChen/deepagents/commit/06f46fffe36efa9f3adcb331b07df283d8bed874))
* **code:** improve onboarding Installed Integrations screen ([#4195](https://github.com/EralChen/deepagents/issues/4195)) ([0827bf1](https://github.com/EralChen/deepagents/commit/0827bf1b635b825121740ac8946dd6d98c815c7d))
* **code:** in-app Debug Console ([#4564](https://github.com/EralChen/deepagents/issues/4564)) ([4f94a30](https://github.com/EralChen/deepagents/commit/4f94a30c11efb1819b08647d15b50b9b1e7bf043))
* **code:** in-the-moment trust prompt for symlinked skills ([#4200](https://github.com/EralChen/deepagents/issues/4200)) ([a4431e4](https://github.com/EralChen/deepagents/commit/a4431e4339348431e91533cb2b177259ab94b083))
* **code:** make plugins generally available ([#4797](https://github.com/EralChen/deepagents/issues/4797)) ([3da6e47](https://github.com/EralChen/deepagents/commit/3da6e471c26f1da4cddeb12a435bab92bd7866c6))
* **code:** move `/goal` criteria generation server-side ([#4754](https://github.com/EralChen/deepagents/issues/4754)) ([9fdd498](https://github.com/EralChen/deepagents/commit/9fdd498937842e2ac490ae0e0ca74eef47abd0bb))
* **code:** non-interactive rubric grading flags ([#4305](https://github.com/EralChen/deepagents/issues/4305)) ([1bcb112](https://github.com/EralChen/deepagents/commit/1bcb112ee78138eca9cb400c206ce198322aae32))
* **code:** offer abort during resume ([#4188](https://github.com/EralChen/deepagents/issues/4188)) ([a4c25cd](https://github.com/EralChen/deepagents/commit/a4c25cd74de9902fd0ea9440b5dda2d4248bb3d2))
* **code:** offer abort in `/threads` cwd-switch prompt ([#4583](https://github.com/EralChen/deepagents/issues/4583)) ([aaeac99](https://github.com/EralChen/deepagents/commit/aaeac99d9f17b6a55d663c21a4d063444b6a1870))
* **code:** offer restart after saving Tavily key via `/auth` ([#4560](https://github.com/EralChen/deepagents/issues/4560)) ([12df81a](https://github.com/EralChen/deepagents/commit/12df81ad00d814c570b4d24a2b06de9b18d51abd))
* **code:** persist reasoning effort across restarts ([#4728](https://github.com/EralChen/deepagents/issues/4728)) ([c584dcf](https://github.com/EralChen/deepagents/commit/c584dcfb3ad287446e0209b8bd4ca31cee587eea))
* **code:** persistent banner when installation is stale ([#4459](https://github.com/EralChen/deepagents/issues/4459)) ([b74c185](https://github.com/EralChen/deepagents/commit/b74c18591a8ce9a49a5fee43b07e602ca9fbf68a))
* **code:** quit shortcut on completed update modal ([#4312](https://github.com/EralChen/deepagents/issues/4312)) ([5e6eae9](https://github.com/EralChen/deepagents/commit/5e6eae9f094a5167b6bf01f2d84cf06ca5cd80c3))
* **code:** reload env from `/auth` modal via Ctrl+R ([#4566](https://github.com/EralChen/deepagents/issues/4566)) ([f07d638](https://github.com/EralChen/deepagents/commit/f07d6387b7dc1f0e880f77784905c2aa94143adb))
* **code:** report tracing gateway in `dcode doctor` ([#4466](https://github.com/EralChen/deepagents/issues/4466)) ([a912427](https://github.com/EralChen/deepagents/commit/a9124275504bc1af5f76dfdd9a6c558c98eea92d))
* **code:** restore interrupted prompt to input on ESC ([#4544](https://github.com/EralChen/deepagents/issues/4544)) ([fccf037](https://github.com/EralChen/deepagents/commit/fccf03732140d39749e70e8fc6cb7d73124a1d70))
* **code:** resume threads in-TUI with `/threads -r [ID]` ([#4609](https://github.com/EralChen/deepagents/issues/4609)) ([d442673](https://github.com/EralChen/deepagents/commit/d44267358e272553c8ece33d367514430be7c0da))
* **code:** selective per-server project MCP trust ([#4507](https://github.com/EralChen/deepagents/issues/4507)) ([aaa22a9](https://github.com/EralChen/deepagents/commit/aaa22a9340cb3d2c8e9ce1a921957d0a9121da20))
* **code:** set `prompt_cache_key` for OpenAI models ([#4632](https://github.com/EralChen/deepagents/issues/4632)) ([8cf57ac](https://github.com/EralChen/deepagents/commit/8cf57aca9f41c3c4ca6d9796dc2cb80d4b22fb6d))
* **code:** show `"Took <duration>"` after `execute` finishes ([#4301](https://github.com/EralChen/deepagents/issues/4301)) ([a5240eb](https://github.com/EralChen/deepagents/commit/a5240ebe3654e72fa5beb4070224f52f944768c8))
* **code:** show `(debug enabled)` on splash when `DEEPAGENTS_CODE_DEBUG` is set ([#4584](https://github.com/EralChen/deepagents/issues/4584)) ([f10b877](https://github.com/EralChen/deepagents/commit/f10b877e5e48c3a1e15bd72d2ce06dfb16203231))
* **code:** show last update check time in `dcode doctor` ([#4307](https://github.com/EralChen/deepagents/issues/4307)) ([b669f37](https://github.com/EralChen/deepagents/commit/b669f37fb08998cfbf983da76f57822215614e7b))
* **code:** show model name instead of spec in switcher ([#4460](https://github.com/EralChen/deepagents/issues/4460)) ([0059620](https://github.com/EralChen/deepagents/commit/005962088ad31b16745c399e4ab2e725e97f7858))
* **code:** simplify welcome banner to compact box ([#4482](https://github.com/EralChen/deepagents/issues/4482)) ([b7f46e9](https://github.com/EralChen/deepagents/commit/b7f46e931807f86476c9c2d661dcd4e9623c10a2))
* **code:** summarize plugin changes on reload ([#4767](https://github.com/EralChen/deepagents/issues/4767)) ([9cad2f0](https://github.com/EralChen/deepagents/commit/9cad2f00dd0473828f80f782c889b939483727f6))
* **code:** support Fireworks `/routers` model ids ([#4591](https://github.com/EralChen/deepagents/issues/4591)) ([1c08d27](https://github.com/EralChen/deepagents/commit/1c08d2705f73f6870610849e00910b94458accf1))
* **code:** surface `/auth` in `/trace not-configured` hint ([#4206](https://github.com/EralChen/deepagents/issues/4206)) ([392e410](https://github.com/EralChen/deepagents/commit/392e410e48639a56fda5e35b6f7f85a5215cce9c))
* **code:** surface tracing in `doctor` and `config show` ([#4163](https://github.com/EralChen/deepagents/issues/4163)) ([2bb3e44](https://github.com/EralChen/deepagents/commit/2bb3e44243553a5f2954a0f3ec42364563842a87))
* **code:** toast on saved `/auth` API key ([#4558](https://github.com/EralChen/deepagents/issues/4558)) ([ee3c264](https://github.com/EralChen/deepagents/commit/ee3c26415be84e369b829fefb21461c8ec210a5e))
* **code:** toast to re-paste when a chat paste collapses ([#4742](https://github.com/EralChen/deepagents/issues/4742)) ([e50e238](https://github.com/EralChen/deepagents/commit/e50e2383261ba39923b5d6c48b7fe3b058475cd3))
* **code:** toast when opening a clicked URL ([#4368](https://github.com/EralChen/deepagents/issues/4368)) ([434f29e](https://github.com/EralChen/deepagents/commit/434f29e5cb3d94988e2a4d80b78452bee4b10812))
* **code:** trace auto-approve (YOLO) mode in trace metadata ([#4764](https://github.com/EralChen/deepagents/issues/4764)) ([d88601e](https://github.com/EralChen/deepagents/commit/d88601ed582b89d4a5b517e842029d06370c0891))
* **code:** trace experimental mode in metadata ([#4705](https://github.com/EralChen/deepagents/issues/4705)) ([22d5045](https://github.com/EralChen/deepagents/commit/22d50456324e9b8c0121a3a06787e19c1b88e1aa))
* **code:** unify `config show`/`list` around effective values ([#4174](https://github.com/EralChen/deepagents/issues/4174)) ([ccd9d21](https://github.com/EralChen/deepagents/commit/ccd9d216e77855a28b88850beb525f47ce8b686a))
* **sdk:** optional video frame extraction on `read_file` ([#4094](https://github.com/EralChen/deepagents/issues/4094)) ([b927147](https://github.com/EralChen/deepagents/commit/b927147d026749c6c790bb06c9853515dabf579c))


### Bug Fixes

* **code:** `--reinstall` on `/install` so upgrades rebuild a clean env ([#4196](https://github.com/EralChen/deepagents/issues/4196)) ([5e152ac](https://github.com/EralChen/deepagents/commit/5e152ac0256d64376f96b293f8844bc8acc993ec))
* **code:** `dcode doctor` shows `not configured` for unset tracing ([#4318](https://github.com/EralChen/deepagents/issues/4318)) ([e323d0c](https://github.com/EralChen/deepagents/commit/e323d0c7d91f3b11e03a016c14cf52008dc66b55))
* **code:** add marketplaces asynchronously ([#4766](https://github.com/EralChen/deepagents/issues/4766)) ([0d1bb6a](https://github.com/EralChen/deepagents/commit/0d1bb6a1224b91cae9dcdb7014a6410a82b79001))
* **code:** align context diff rows with changed rows ([#4714](https://github.com/EralChen/deepagents/issues/4714)) ([f9915db](https://github.com/EralChen/deepagents/commit/f9915db4206ef2d794ad07fdccbdd4ee58963142))
* **code:** allow `/remember` with args when no conversation history ([#4418](https://github.com/EralChen/deepagents/issues/4418)) ([5df9c83](https://github.com/EralChen/deepagents/commit/5df9c83b58f2529561848ae9f1364961e1c80641))
* **code:** allow suppressing LangSmith key override warning ([#4436](https://github.com/EralChen/deepagents/issues/4436)) ([ddcae5e](https://github.com/EralChen/deepagents/commit/ddcae5e0bd9aebc946be1d9fb3f5e35eeb690fa6))
* **code:** avoid blocking MCP imports during graph readiness ([#4302](https://github.com/EralChen/deepagents/issues/4302)) ([7533ca8](https://github.com/EralChen/deepagents/commit/7533ca89f3afc9863ba5e1ecee2d4c5974dea320))
* **code:** avoid blocking MCP OAuth token refresh ([#4770](https://github.com/EralChen/deepagents/issues/4770)) ([3b2ffce](https://github.com/EralChen/deepagents/commit/3b2ffce923e06370efe177e9ca91f70e86f19602))
* **code:** avoid duplicate "criteria ready" message on `/goal` revisions ([#4559](https://github.com/EralChen/deepagents/issues/4559)) ([1110497](https://github.com/EralChen/deepagents/commit/1110497e17fac6deceb9d1d6e530f9197bfc0d4a))
* **code:** avoid repeated startup auto-update stalls ([#4648](https://github.com/EralChen/deepagents/issues/4648)) ([12a9c9d](https://github.com/EralChen/deepagents/commit/12a9c9d6813a83e5eeff9feed0c4068d1fcc69c4))
* **code:** bake release commit into `dcode doctor` ([#4225](https://github.com/EralChen/deepagents/issues/4225)) ([6dc0246](https://github.com/EralChen/deepagents/commit/6dc0246f5c6e9170e05191e1c82fad6975ac945c))
* **code:** bind ephemeral port instead of squatting `langgraph dev`'s 2024 ([#4264](https://github.com/EralChen/deepagents/issues/4264)) ([11e5359](https://github.com/EralChen/deepagents/commit/11e5359851f0291783661b4311ad5e4436a36fb7))
* **code:** block dotenv shell startup hooks ([#4288](https://github.com/EralChen/deepagents/issues/4288)) ([686d6f3](https://github.com/EralChen/deepagents/commit/686d6f3a1da8b6393efb4c0cf87b3eb35e0cca50))
* **code:** capture input typed before TUI startup ([#4684](https://github.com/EralChen/deepagents/issues/4684)) ([ef9a4a8](https://github.com/EralChen/deepagents/commit/ef9a4a8770f4daec70e640d6d2f23dd798d4ede2))
* **code:** clarify managed `rg` install failures ([#4578](https://github.com/EralChen/deepagents/issues/4578)) ([434c84a](https://github.com/EralChen/deepagents/commit/434c84ae144b0319afe37d6f2dbadfd7f5fc9f70))
* **code:** clarify plugin component discovery and reload status ([#4774](https://github.com/EralChen/deepagents/issues/4774)) ([7d707b8](https://github.com/EralChen/deepagents/commit/7d707b840f132ad65e5ac8443ec7fece393180f8))
* **code:** clean offloaded history when deleting a thread ([#4751](https://github.com/EralChen/deepagents/issues/4751)) ([47788ed](https://github.com/EralChen/deepagents/commit/47788ededafd44f74b4368ec6793bf4685ad3a3a))
* **code:** clear stale live approval mode keys ([#4242](https://github.com/EralChen/deepagents/issues/4242)) ([f11a769](https://github.com/EralChen/deepagents/commit/f11a76962c9d536a38e27ac05b32feca364b2424))
* **code:** clear transient update launch status ([#4355](https://github.com/EralChen/deepagents/issues/4355)) ([b870b18](https://github.com/EralChen/deepagents/commit/b870b18750f65442009028a85a2ac18f1b06640c))
* **code:** clearer MCP config JSON parse errors ([#4327](https://github.com/EralChen/deepagents/issues/4327)) ([9cee602](https://github.com/EralChen/deepagents/commit/9cee60274d38d4ad8a2d7a7e9d3ae59aebce5261))
* **code:** close subprocess transport on install teardown ([#4735](https://github.com/EralChen/deepagents/issues/4735)) ([625e601](https://github.com/EralChen/deepagents/commit/625e601da8cd77e13b98b2b81626f320478108dc))
* **code:** complete goals after satisfied grading ([#4781](https://github.com/EralChen/deepagents/issues/4781)) ([682ce0f](https://github.com/EralChen/deepagents/commit/682ce0fc760e96cf546ea9c97050293548aebc45))
* **code:** dedupe update/install log path output ([#4553](https://github.com/EralChen/deepagents/issues/4553)) ([1398fee](https://github.com/EralChen/deepagents/commit/1398feeca507cab9ec51a66604d46c747f7fcd2f))
* **code:** deduplicate content from system prompt by overwriting base prompt ([#4516](https://github.com/EralChen/deepagents/issues/4516)) ([2266f58](https://github.com/EralChen/deepagents/commit/2266f58e4713d23ba0b30eb8646424d01165c11b))
* **code:** defer server graph construction ([#4300](https://github.com/EralChen/deepagents/issues/4300)) ([220dfc0](https://github.com/EralChen/deepagents/commit/220dfc0e6b03f9ccb499c6b850c586b9d57cc077))
* **code:** detach owned `langgraph dev` server from terminal ([#4642](https://github.com/EralChen/deepagents/issues/4642)) ([d1f3afe](https://github.com/EralChen/deepagents/commit/d1f3afecdc015b5d1c9fb098d6347c7d7180e417))
* **code:** dismiss startup tip on `-m` initial submission ([#4779](https://github.com/EralChen/deepagents/issues/4779)) ([8acd414](https://github.com/EralChen/deepagents/commit/8acd414a2e712d8b8b1968e40bff40483196856b))
* **code:** drop duplicate token-request `client_id` under Basic auth ([#4323](https://github.com/EralChen/deepagents/issues/4323)) ([426dfad](https://github.com/EralChen/deepagents/commit/426dfad3ea1e453914cb87efa8fc70fb85a9efcb))
* **code:** drop redundant version from "already up to date" message ([#4223](https://github.com/EralChen/deepagents/issues/4223)) ([5d080df](https://github.com/EralChen/deepagents/commit/5d080df2776d380214bf20ae31266b9628e4e5b0))
* **code:** eager managed ripgrep install via `dcode tools install` ([#4199](https://github.com/EralChen/deepagents/issues/4199)) ([cf536f3](https://github.com/EralChen/deepagents/commit/cf536f339958d6726fa41f896c4a3e42df644c9f))
* **code:** ensure unique message widget IDs on history load ([#4454](https://github.com/EralChen/deepagents/issues/4454)) ([de2f7d2](https://github.com/EralChen/deepagents/commit/de2f7d2835485df905772e1c96e33d2c239d8e22))
* **code:** exclude managed bin dir from agent picker ([#4190](https://github.com/EralChen/deepagents/issues/4190)) ([d869d1e](https://github.com/EralChen/deepagents/commit/d869d1e1fa8558510fb48e71f78fb74c69ca4840))
* **code:** full-width chat messages, hide scrollbar, flush input bg ([#4374](https://github.com/EralChen/deepagents/issues/4374)) ([1f8e8dc](https://github.com/EralChen/deepagents/commit/1f8e8dc942ac54c4014ac48f9345ee0201be0b1b))
* **code:** gate `delete` file operations ([#4299](https://github.com/EralChen/deepagents/issues/4299)) ([92a8681](https://github.com/EralChen/deepagents/commit/92a86819adfefbc6ccfd01a861191ba292eca754))
* **code:** generic "missing credentials" in model switcher ([#4182](https://github.com/EralChen/deepagents/issues/4182)) ([456ce5c](https://github.com/EralChen/deepagents/commit/456ce5c2f5487a754d1fea7046e32c03b7e27a17))
* **code:** handle LangSmith project-not-found and default tracing project ([#4153](https://github.com/EralChen/deepagents/issues/4153)) ([e303ce9](https://github.com/EralChen/deepagents/commit/e303ce986a3595f0cf458e796d857f7c8f5f8b5c))
* **code:** handle recursive `fetch_url` conversion ([#4257](https://github.com/EralChen/deepagents/issues/4257)) ([f240a40](https://github.com/EralChen/deepagents/commit/f240a40dc05d812c38e9926c1d81ba38deb86e3f))
* **code:** harden approval content rendering ([#4581](https://github.com/EralChen/deepagents/issues/4581)) ([38446fd](https://github.com/EralChen/deepagents/commit/38446fda649b891dd8604e788701eabe739c1dd0))
* **code:** hide "Recent" section during onboarding model selection ([#4198](https://github.com/EralChen/deepagents/issues/4198)) ([af882e4](https://github.com/EralChen/deepagents/commit/af882e4f6c859878e350d8a37bb75b7bc01bb453))
* **code:** hide chat input action buttons in same frame as empty draft ([#4178](https://github.com/EralChen/deepagents/issues/4178)) ([f94d417](https://github.com/EralChen/deepagents/commit/f94d417d5ad9928db967777fe1d7bc2c37684fb9))
* **code:** highlight just-installed provider on `/auth` reopen ([#4311](https://github.com/EralChen/deepagents/issues/4311)) ([85e47b5](https://github.com/EralChen/deepagents/commit/85e47b532b5caf92a52f1a070a95bdb39bee6d3d))
* **code:** honest MCP OAuth callback close message ([#4410](https://github.com/EralChen/deepagents/issues/4410)) ([ef637f4](https://github.com/EralChen/deepagents/commit/ef637f4a3f38ee155ad7d31e64a5cdd7bfaee62c))
* **code:** honor Baseten base URL env precedence ([#4328](https://github.com/EralChen/deepagents/issues/4328)) ([8f20d74](https://github.com/EralChen/deepagents/commit/8f20d74892112c3b88aaca63d8c04a355fd6726f))
* **code:** hydrate transcript tail when scrolled to the bottom edge ([#4733](https://github.com/EralChen/deepagents/issues/4733)) ([02a2461](https://github.com/EralChen/deepagents/commit/02a246144c764a1c57b60223652ade8716c7529b))
* **code:** hydrate virtualized transcript on scroll offset changes ([#4646](https://github.com/EralChen/deepagents/issues/4646)) ([f77eeb0](https://github.com/EralChen/deepagents/commit/f77eeb0a036281f84bf7d0b05ea60e02630f55c1))
* **code:** improve empty marketplace onboarding and list polish ([#4759](https://github.com/EralChen/deepagents/issues/4759)) ([ab2e101](https://github.com/EralChen/deepagents/commit/ab2e101d02d0fc5be45b0581c4e04d441402dc29))
* **code:** include skill invocations in input history ([#4211](https://github.com/EralChen/deepagents/issues/4211)) ([7b8d0b2](https://github.com/EralChen/deepagents/commit/7b8d0b2ec184e0d9a0cbe858a0d9a7128791969d))
* **code:** infer additional model providers ([#4675](https://github.com/EralChen/deepagents/issues/4675)) ([4ceed24](https://github.com/EralChen/deepagents/commit/4ceed24d3758801ed9df1024602e90488004cef1))
* **code:** infer Fireworks provider from qualified model IDs ([#4594](https://github.com/EralChen/deepagents/issues/4594)) ([4d2aa8a](https://github.com/EralChen/deepagents/commit/4d2aa8a9684609eee45cd93b0af5149d8dd09eea))
* **code:** interrupt remote runs on chat cancellation ([#4234](https://github.com/EralChen/deepagents/issues/4234)) ([37c5fa2](https://github.com/EralChen/deepagents/commit/37c5fa23e621616836694bc59c1b0c38def81604))
* **code:** keep auth modal interactive after install-on-select ([#4187](https://github.com/EralChen/deepagents/issues/4187)) ([afbc56a](https://github.com/EralChen/deepagents/commit/afbc56a1d9dbe8a89015f4c2f90bb87547d5c1d4))
* **code:** keep chat input responsive during MCP viewer `Ctrl+R` reconnect ([#4753](https://github.com/EralChen/deepagents/issues/4753)) ([28dc96d](https://github.com/EralChen/deepagents/commit/28dc96d08bc057f2e435b557062a819db4191310))
* **code:** keep footer branch visible and ellipsized instead of hiding when narrow ([#4506](https://github.com/EralChen/deepagents/issues/4506)) ([ccf30c3](https://github.com/EralChen/deepagents/commit/ccf30c342e5ead677aafd196d8f1ddd2bdf95196))
* **code:** keep notification center open for API-key entry ([#4568](https://github.com/EralChen/deepagents/issues/4568)) ([6e89417](https://github.com/EralChen/deepagents/commit/6e8941776cdcc35909da305f3bb39500c0f479cb))
* **code:** keep TODO and edit tools expanded ([#4704](https://github.com/EralChen/deepagents/issues/4704)) ([1d549d3](https://github.com/EralChen/deepagents/commit/1d549d3f3c9bb60c3ce39d4a0c913bcefe9610d5))
* **code:** make `/goal` completion and grading reliable ([#4691](https://github.com/EralChen/deepagents/issues/4691)) ([9da63c6](https://github.com/EralChen/deepagents/commit/9da63c64a59503e3366e9bc7224cb1251af476be))
* **code:** make `/timestamps` toggle instant via per-footer class ([#4095](https://github.com/EralChen/deepagents/issues/4095)) ([7ae32b0](https://github.com/EralChen/deepagents/commit/7ae32b0a606cc200d4311e11036a65f17e8282b3))
* **code:** make execute command expandable in code TUI transcript ([#4428](https://github.com/EralChen/deepagents/issues/4428)) ([d999181](https://github.com/EralChen/deepagents/commit/d999181e8424498681f1e442c71380bf6b82b0aa))
* **code:** match primary-input `Ctrl+D` behavior in inline free-text fields ([#4729](https://github.com/EralChen/deepagents/issues/4729)) ([8a6963b](https://github.com/EralChen/deepagents/commit/8a6963ba52eee2ab8de5df2c14210f472c828d38))
* **code:** note subscription plans unusable for Anthropic in `/auth` ([#4207](https://github.com/EralChen/deepagents/issues/4207)) ([28cd19d](https://github.com/EralChen/deepagents/commit/28cd19db08bacf981ab2c91195638e66072816fe))
* **code:** offload `create_model` in server graph factory to unblock Codex ([#4324](https://github.com/EralChen/deepagents/issues/4324)) ([064ea0c](https://github.com/EralChen/deepagents/commit/064ea0c6851353d0b0bc347a0758149765688945))
* **code:** partition Debug Console log retention by level ([#4718](https://github.com/EralChen/deepagents/issues/4718)) ([c6e3b35](https://github.com/EralChen/deepagents/commit/c6e3b351f1826aa6ea97be244acd867950a032ee))
* **code:** persist resume model state privately ([#4400](https://github.com/EralChen/deepagents/issues/4400)) ([bbd0f0d](https://github.com/EralChen/deepagents/commit/bbd0f0d1ddc9d22d399a819d7b4363f7997d119e))
* **code:** persist rubric model after server restart ([#4419](https://github.com/EralChen/deepagents/issues/4419)) ([5605a68](https://github.com/EralChen/deepagents/commit/5605a681c9fec888d8c6dfbde2decd4692c8cef0))
* **code:** pin app version when installing extras ([#4313](https://github.com/EralChen/deepagents/issues/4313)) ([c20c8e2](https://github.com/EralChen/deepagents/commit/c20c8e2fc138f72f1444107d2a936305a591807b))
* **code:** pin filelock below 3.30 to avoid blocking import ([#4786](https://github.com/EralChen/deepagents/issues/4786)) ([f9b7d75](https://github.com/EralChen/deepagents/commit/f9b7d75f24301081ae8973cd59f00e609eb024c5))
* **code:** preflight Ollama host reachability before discovery probe ([#4702](https://github.com/EralChen/deepagents/issues/4702)) ([96fe71a](https://github.com/EralChen/deepagents/commit/96fe71a3815e1020edeb3be1af70b0cadb85931c))
* **code:** preserve `Ctrl+D` deletion in non-empty input ([#4626](https://github.com/EralChen/deepagents/issues/4626)) ([306bd89](https://github.com/EralChen/deepagents/commit/306bd893f214237b6b4eede7c2ce0eaff66f5527))
* **code:** preserve transcript order during virtualization ([#4549](https://github.com/EralChen/deepagents/issues/4549)) ([f6ee70c](https://github.com/EralChen/deepagents/commit/f6ee70c00ac6ad7b1b180155018b794308a18361))
* **code:** preserve uv tool context when installing extras ([#4201](https://github.com/EralChen/deepagents/issues/4201)) ([fcc616c](https://github.com/EralChen/deepagents/commit/fcc616cf9bc2bbc7b2dc2574ae8649e2f270dc53))
* **code:** prevent `UnicodeEncodeError` crash in non-interactive mode on legacy Windows consoles ([#4478](https://github.com/EralChen/deepagents/issues/4478)) ([b1b16cd](https://github.com/EralChen/deepagents/commit/b1b16cd114d4ee4f077cf5824a0176cd94ebd851))
* **code:** put local offloaded tool results on the real filesystem ([#4740](https://github.com/EralChen/deepagents/issues/4740)) ([36051e2](https://github.com/EralChen/deepagents/commit/36051e2a6cdcd9c22f6118f5cfc481e0540913ea))
* **code:** queue `/mcp login` sent before the server connects ([#4533](https://github.com/EralChen/deepagents/issues/4533)) ([edac82c](https://github.com/EralChen/deepagents/commit/edac82c837de8e12b58b97ac25acc31f743d4c5d))
* **code:** quiet expected non-repo `git ls-files` logging ([#4701](https://github.com/EralChen/deepagents/issues/4701)) ([3d499db](https://github.com/EralChen/deepagents/commit/3d499db8a6c76743810a8983107d7c7d7bdb35e6))
* **code:** quiet routine ripgrep installer output ([#4417](https://github.com/EralChen/deepagents/issues/4417)) ([a52c18d](https://github.com/EralChen/deepagents/commit/a52c18d3ef8fe462d1289dca8798c51450e0368a))
* **code:** quiet uv installer output and require Xcode CLT on macOS ([#4180](https://github.com/EralChen/deepagents/issues/4180)) ([785c8d0](https://github.com/EralChen/deepagents/commit/785c8d0061114f8f3c457d4afc35a83bd405fc1b))
* **code:** quit with `Ctrl+D` at end of prompt ([#4678](https://github.com/EralChen/deepagents/issues/4678)) ([2f8c111](https://github.com/EralChen/deepagents/commit/2f8c11176f5cc9350c3337b2dfcf9f19886d5d02))
* **code:** re-apply theme preference on `/reload` ([#4514](https://github.com/EralChen/deepagents/issues/4514)) ([5d1c392](https://github.com/EralChen/deepagents/commit/5d1c3928f7ca0ea97f28fd4d34ae1a4ee885e888))
* **code:** reap langgraph dev server when startup is cancelled ([#4629](https://github.com/EralChen/deepagents/issues/4629)) ([904ff05](https://github.com/EralChen/deepagents/commit/904ff05620a576100e05fd65810d38405c4942d4))
* **code:** record shell output as user context ([#4353](https://github.com/EralChen/deepagents/issues/4353)) ([0d504a5](https://github.com/EralChen/deepagents/commit/0d504a5df8454e871597932ce1cd3e95b10ab00e))
* **code:** redact LangSmith trace secrets by default ([#4356](https://github.com/EralChen/deepagents/issues/4356)) ([5e01fec](https://github.com/EralChen/deepagents/commit/5e01fec72d8b179a3b075b07268162d2eaebfe84))
* **code:** refocus `/mcp` filter input after in-place refresh ([#4080](https://github.com/EralChen/deepagents/issues/4080)) ([d79cd74](https://github.com/EralChen/deepagents/commit/d79cd74cb8a44c300c3bbad712fe77e709f9221a))
* **code:** reject `--auto-approve` in headless mode ([#4617](https://github.com/EralChen/deepagents/issues/4617)) ([997be16](https://github.com/EralChen/deepagents/commit/997be1643aff6d6900b8b8c95832cdf93be8c0d7))
* **code:** remove MCP OAuth success page message shift ([#4463](https://github.com/EralChen/deepagents/issues/4463)) ([69bb06c](https://github.com/EralChen/deepagents/commit/69bb06c0680fa6d37b917deb6b70927c3eff9c09))
* **code:** remove misleading agent names from help ([#4671](https://github.com/EralChen/deepagents/issues/4671)) ([ac15732](https://github.com/EralChen/deepagents/commit/ac1573281530c1564fe07f8a21608e4d4dec2c3b))
* **code:** rename `ls_agent_kind` to `ls_agent_purpose` ([#4708](https://github.com/EralChen/deepagents/issues/4708)) ([2678b16](https://github.com/EralChen/deepagents/commit/2678b1680d8928e72e8efae00632a694c9b2737a))
* **code:** report editable SDK runtime version ([#4304](https://github.com/EralChen/deepagents/issues/4304)) ([4439e91](https://github.com/EralChen/deepagents/commit/4439e912da4bfa6f1e38e14b5a03d2bfe9367d3b))
* **code:** report same-version dependency updates ([#4146](https://github.com/EralChen/deepagents/issues/4146)) ([156e118](https://github.com/EralChen/deepagents/commit/156e1185242a19746f8c268904637c73f07b9a10))
* **code:** resolve `/threads` header link on mount, not after load ([#4453](https://github.com/EralChen/deepagents/issues/4453)) ([4cba728](https://github.com/EralChen/deepagents/commit/4cba72893fc4aae5b429d8c573c1a513d97ddf8a))
* **code:** resolve editable SDK version metadata ([#4394](https://github.com/EralChen/deepagents/issues/4394)) ([3239bf4](https://github.com/EralChen/deepagents/commit/3239bf4edf2be3037bb18315463ac6a0c3537e5c))
* **code:** restore caller's LangSmith API key in shell subprocess env ([#4458](https://github.com/EralChen/deepagents/issues/4458)) ([9293b19](https://github.com/EralChen/deepagents/commit/9293b190170a872b73d0d94e66479bcc5f7962c7))
* **code:** restore marketplace details keyboard focus [closes DCD-50] ([#4763](https://github.com/EralChen/deepagents/issues/4763)) ([e821d3d](https://github.com/EralChen/deepagents/commit/e821d3dd26e8cd0c6ada1a44ceaceddad9f5ee80))
* **code:** restore welcome banner tips ([#4528](https://github.com/EralChen/deepagents/issues/4528)) ([3f1e55e](https://github.com/EralChen/deepagents/commit/3f1e55eafbc1fde79cb75f631561cf35d4b8ff4c))
* **code:** route Anthropic effort through output config ([#4446](https://github.com/EralChen/deepagents/issues/4446)) ([1e8ed81](https://github.com/EralChen/deepagents/commit/1e8ed81940a862dde44f704826b61650336367e0))
* **code:** route explicit `--stdin` + `--skill` to headless path ([#4611](https://github.com/EralChen/deepagents/issues/4611)) ([724e24a](https://github.com/EralChen/deepagents/commit/724e24a31546e1f31feca3bb2344717550682595))
* **code:** run `/offload` server-side ([#4696](https://github.com/EralChen/deepagents/issues/4696)) ([564e5a0](https://github.com/EralChen/deepagents/commit/564e5a05bca5236ae33ce1147865111f931d257c))
* **code:** run MCP login during a run, queue the restart ([#4643](https://github.com/EralChen/deepagents/issues/4643)) ([65e1ee8](https://github.com/EralChen/deepagents/commit/65e1ee802e2f69762a6d8e6c7c6d37060161ea5a))
* **code:** run stdio MCP server pre-flight check off the event loop ([#4434](https://github.com/EralChen/deepagents/issues/4434)) ([c9636e2](https://github.com/EralChen/deepagents/commit/c9636e22725a5bd32c1f8b9e739b02b4aa7c3dc7))
* **code:** serialize MCP OAuth token refreshes to prevent reuse revocation ([#4565](https://github.com/EralChen/deepagents/issues/4565)) ([c37100d](https://github.com/EralChen/deepagents/commit/c37100d4763e527fce12fa4451794ca25ded7640))
* **code:** share paste handling with inline free-text prompts ([#4736](https://github.com/EralChen/deepagents/issues/4736)) ([369ec69](https://github.com/EralChen/deepagents/commit/369ec6920af35cdec713b9e27d0d1816cafaf556))
* **code:** show "Loading..." in `/threads` agent dropdown while loading ([#4101](https://github.com/EralChen/deepagents/issues/4101)) ([c2d949e](https://github.com/EralChen/deepagents/commit/c2d949e8765fbbbdb81e5a70125932842358099f))
* **code:** show "Took &lt;duration&gt;" when `task` tool completes ([#4638](https://github.com/EralChen/deepagents/issues/4638)) ([19538e0](https://github.com/EralChen/deepagents/commit/19538e0a46a5c2c050412b79fd45608a63cdde52))
* **code:** show `(local)` tag under ANSI themes ([#4534](https://github.com/EralChen/deepagents/issues/4534)) ([699e439](https://github.com/EralChen/deepagents/commit/699e439699723e477a621f95eef87a7d76aac5f5))
* **code:** show loading state during model switch ([#4209](https://github.com/EralChen/deepagents/issues/4209)) ([7cc4e9f](https://github.com/EralChen/deepagents/commit/7cc4e9f9bda5a8ae42bb072b82b634ad8c39ade1))
* **code:** show months instead of "0y ago" for 360-364 day old timestamps ([#4267](https://github.com/EralChen/deepagents/issues/4267)) ([820b331](https://github.com/EralChen/deepagents/commit/820b331552cb7ce4695ddca3c9b8343a3144392b))
* **code:** skip Esc prompt-restore once output generation begins ([#4582](https://github.com/EralChen/deepagents/issues/4582)) ([14f384f](https://github.com/EralChen/deepagents/commit/14f384fc0083c07a7f44f97543b40b74cf93c13f))
* **code:** skip tool interrupts once auto-approve is set ([#4092](https://github.com/EralChen/deepagents/issues/4092)) ([9e21c34](https://github.com/EralChen/deepagents/commit/9e21c346a6eb8ad25b9cc671f24527b07732e2b7))
* **code:** strip input before Ctrl+C copy-input fallback ([#4590](https://github.com/EralChen/deepagents/issues/4590)) ([505d55a](https://github.com/EralChen/deepagents/commit/505d55ad83e8569213175911ee6c8c39fbbf340c))
* **code:** strip media placeholders from model-facing message text ([#4462](https://github.com/EralChen/deepagents/issues/4462)) ([aa0ae36](https://github.com/EralChen/deepagents/commit/aa0ae36b00df6411a9200610a9075ef2dc28b1af))
* **code:** support plain `exit` quit command ([#4543](https://github.com/EralChen/deepagents/issues/4543)) ([e6f10a1](https://github.com/EralChen/deepagents/commit/e6f10a149051128677c9f6f37663922054a7ac26))
* **code:** support unambiguous `read_file` gutters ([#4711](https://github.com/EralChen/deepagents/issues/4711)) ([2089b54](https://github.com/EralChen/deepagents/commit/2089b54e2a674ede313e790b59febf9dc6f22571))
* **code:** suppress auto-update migration notice on fresh installs ([#4224](https://github.com/EralChen/deepagents/issues/4224)) ([eb8ff80](https://github.com/EralChen/deepagents/commit/eb8ff809a1b3130a261083c66a193e532095c6db))
* **code:** suppress expected MCP reauth logs ([#4359](https://github.com/EralChen/deepagents/issues/4359)) ([15ee384](https://github.com/EralChen/deepagents/commit/15ee384117ccd955f7481346dd92b7f4b007a60d))
* **code:** surface `/auth`-stored credentials in `config show`/`get` ([#4258](https://github.com/EralChen/deepagents/issues/4258)) ([c7c8788](https://github.com/EralChen/deepagents/commit/c7c8788ecf0068914298a6055a5f3fd31c36bd44))
* **code:** surface tool calls awaiting approval ([#4739](https://github.com/EralChen/deepagents/issues/4739)) ([8148724](https://github.com/EralChen/deepagents/commit/814872492eb2bed4d5c382c6c1fe985ad4354b68))
* **code:** switch input mode without flashing the mode trigger ([#4243](https://github.com/EralChen/deepagents/issues/4243)) ([fc5d9cb](https://github.com/EralChen/deepagents/commit/fc5d9cb8fb978ec95f98407692d4809ea1e86577))
* **code:** sync `ask_user` active-question highlight with focus ([#4599](https://github.com/EralChen/deepagents/issues/4599)) ([e4c29b5](https://github.com/EralChen/deepagents/commit/e4c29b5264413d23d8dc70cabae72feb5f3f3dcb))
* **code:** sync approval toggles during active runs ([#4239](https://github.com/EralChen/deepagents/issues/4239)) ([4600365](https://github.com/EralChen/deepagents/commit/4600365ea0b60c3e9113ecf59b5336be37d03428))
* **code:** targeted uv constraints for dcode prerelease deps ([#4744](https://github.com/EralChen/deepagents/issues/4744)) ([36c4024](https://github.com/EralChen/deepagents/commit/36c40241b85ec5b0452d9ca334e5f09b95dc16aa))
* **code:** unblock MCP force reconnect modal ([#4396](https://github.com/EralChen/deepagents/issues/4396)) ([8b7eab0](https://github.com/EralChen/deepagents/commit/8b7eab023db686f577d16f4f9ac872205baf136f))
* **code:** unpin uv self-updates and warn when a stale dcode shadows PATH ([#4185](https://github.com/EralChen/deepagents/issues/4185)) ([8ca0a18](https://github.com/EralChen/deepagents/commit/8ca0a185a15f800267cc057178a348fb5063df1e))
* **code:** warn on `/trace` when thread has no messages ([#4162](https://github.com/EralChen/deepagents/issues/4162)) ([c338fc9](https://github.com/EralChen/deepagents/commit/c338fc914fcd383beb4b97c13f53dfb2684f8c90))
* **code:** wrap MCP viewer navigation ([#4677](https://github.com/EralChen/deepagents/issues/4677)) ([cffc732](https://github.com/EralChen/deepagents/commit/cffc73213bfdcec26cb82c413fa7e27db4afc0ca))


### Performance Improvements

* **code:** background refresh for `@` file completion cache ([#3911](https://github.com/EralChen/deepagents/issues/3911)) ([aa22d6b](https://github.com/EralChen/deepagents/commit/aa22d6b6d5a49e4d6c3aa2d4932df75d14d65f78))
* **code:** load MCP servers concurrently during graph build ([#4659](https://github.com/EralChen/deepagents/issues/4659)) ([c5345cc](https://github.com/EralChen/deepagents/commit/c5345cc04cd810c6238e42dfbfa14497ae1b9020))
* **code:** make `threads list` fast on large session databases ([#4005](https://github.com/EralChen/deepagents/issues/4005)) ([85ca01a](https://github.com/EralChen/deepagents/commit/85ca01a43b002c2bdb4205f48fac5fa6f66a3276))
* **code:** speed up shutdown after Ctrl+C/Ctrl+D ([#4351](https://github.com/EralChen/deepagents/issues/4351)) ([db441ed](https://github.com/EralChen/deepagents/commit/db441ed306a8e03fb68f2ae6a2c08523e248976d))
